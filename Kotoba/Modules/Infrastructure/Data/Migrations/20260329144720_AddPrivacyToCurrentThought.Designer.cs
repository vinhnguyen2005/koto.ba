...
namespace Kotoba.Modules.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260329144720_AddPrivacyToCurrentThought")]
    partial class AddPrivacyToCurrentThought
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kotoba.Modules.Domain.Entities.ReportCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1394bb6a-6ee2-4c3a-b783-89b34ccdc777"),
                            DisplayOrder = 1,
                            IsActive = true,
                            Name = "Spam"
                        },
                        new
                        {
                            Id = new Guid("6864dbed-2aee-4ff0-9cf8-6ef3ad67a027"),
                            DisplayOrder = 2,
                            IsActive = true,
                            Name = "Hate speech"
                        },
                        new
                        {
                            Id = new Guid("2e0cf79b-ecfe-431c-86bb-e290aec83f84"),
                            DisplayOrder = 3,
                            IsActive = true,
                            Name = "Adult content"
                        },
                        new
                        {
                            Id = new Guid("c9ee6653-0a11-4f11-a60d-a7b759f1d10d"),
                            DisplayOrder = 4,
                            IsActive = true,
                            Name = "Harassment"
                        },
                        new
                        {
                            Id = new Guid("d8d9e043-e9d2-45bd-907d-4ae354c8eec9"),
                            DisplayOrder = 5,
                            IsActive = true,
                            Name = "Misinformation"
                        },
                        new
                        {
                            Id = new Guid("6f4012f1-34db-410b-a188-61df65ff4b46"),
                            DisplayOrder = 6,
                            IsActive = true,
                            Name = "Violence"
                        },
                        new
                        {
                            Id = new Guid("cfc3c064-12f7-4337-83e2-180db722d99a"),
                            DisplayOrder = 7,
                            IsActive = true,
                            Name = "Other"
                        });
