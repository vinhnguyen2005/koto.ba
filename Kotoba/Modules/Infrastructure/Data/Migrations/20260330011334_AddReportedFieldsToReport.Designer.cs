...
namespace Kotoba.Modules.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260330011334_AddReportedFieldsToReport")]
    partial class AddReportedFieldsToReport
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Kotoba.Modules.Domain.Entities.ReportCategory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("1492e272-2c27-4593-8f88-722ba92a900b"),
                            DisplayOrder = 1,
                            IsActive = true,
                            Name = "Spam"
                        },
                        new
                        {
                            Id = new Guid("ab06fcf0-c1e1-47ae-a37f-828113618b39"),
                            DisplayOrder = 2,
                            IsActive = true,
                            Name = "Hate speech"
                        },
                        new
                        {
                            Id = new Guid("f425f62d-8c08-4007-be10-ee2fe93f5b63"),
                            DisplayOrder = 3,
                            IsActive = true,
                            Name = "Adult content"
                        },
                        new
                        {
                            Id = new Guid("c0c942a8-fb51-4d86-b9e2-6533a6f24372"),
                            DisplayOrder = 4,
                            IsActive = true,
                            Name = "Harassment"
                        },
                        new
                        {
                            Id = new Guid("09b81f44-3c74-4590-be98-0e039d895917"),
                            DisplayOrder = 5,
                            IsActive = true,
                            Name = "Misinformation"
                        },
                        new
                        {
                            Id = new Guid("a29408f9-cd3c-4faa-8936-540b42ef0f98"),
                            DisplayOrder = 6,
                            IsActive = true,
                            Name = "Violence"
                        },
                        new
                        {
                            Id = new Guid("81af1536-10b8-4d53-958a-54b92f2bc681"),
                            DisplayOrder = 7,
                            IsActive = true,
                            Name = "Other"
                        });
            ...
            modelBuilder.Entity("Kotoba.Modules.Domain.Entities.Report", b =>
                {
                    ...
                    b.HasOne("Kotoba.Modules.Domain.Entities.User", "ReportedUser")
                        .WithMany()
